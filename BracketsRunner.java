...
public class BracketsRunner// implements ErrorMessages
{
    /**
     * Brackets Runner
     * so we have bracket objects that contain players
     * players are saved in text file
     * 
     * format:
     * 
     * Playername:wins:loss:draw
     * 
     * 
     * brackets format:
     * this will use player identifier int
     * id:id
     */
    private static Scanner sc;
    private static String helpText =   
                                "add [name]:[group] : add a player and group " +"\n"+
                                "brackets           : list brackets" +"\n"+
                                "create [#]         : create player group"+"\n"+
                                "del [name]         : delete a player" +"\n"+
                                "find [name]        : list brackets involving player"+"\n"+
                                "list               : list players"+"\n"+
                                "randomize          : "+"\n"+
                                "   all             : randomize all brackets"+"\n"+
                                "   group [#]       : randomize brackets of group"+"\n"+
